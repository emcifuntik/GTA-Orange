...
public:
	...
	static CWorld *Get()
	{
		return *((CWorld**)CMemory::Find("48 8B 05 ? ? ? ? 45 ? ? ? ? 48 8B 48 08 48 85 C9 74 07").getOffset());
	}
}; //Size=0x0010
...
public:
	...
	{
		return (CVehicleFactory*)CMemory::Find("48 83 EC 28 B9 08 00 00 00 E8 ? ? ? ? 48 85 C0 74 11 48 8B C8 E8 ? ? ? ? 48 89 05 ? ? ? ?").getOffset();
	}
}; //Size=0x0088
